...
function setup() {
  ...
  tutorialButton.position(windowWidth*0.32, height*0.77);
  ...
  startButton.position(width*0.55, height*0.52);
  ...
  tvLeftButton.position(width*0.47, height*0.77);
  ...
  tvRightButton.position(width*0.87, height*0.77);
  ...
  eightHonest.position(width*0.42, height*0.63);
  ...
  eightLie.position(width*0.42, height*0.8);
  ...
  eightGenuine.position(width*0.42, height*0.63);
  ...
  eightAnnoyed.position(width*0.42, height*0.8);
  ...
  twnSvnLie.position(width*0.42, height*0.69);
  ...
  twnSvnTruth.position(width*0.42, height*0.83);
  ...
  twnSvnLieBack.position(width*0.42, height*0.69);
  ...
  twnSvnLieCont.position(width*0.42, height*0.83);
  ...
  twnSvnTruthBack.position(width*0.42, height*0.69);
  ...
  twnSvnTruthCont.position(width*0.42, height*0.83);
  ...
  homeButton.position(width*0.53, height*0.4);
  ...
  deadButton.position(width*0.43, height*0.07);
  ...
  survButton.position(width*0.43, height*0.07);
...
function draw() {
  ...
  if (pageNumber < 40) {
    continueBut.position(width*0.42, height*0.72);
    continueBut.style('background-color', '#94a1c1');
    continueBut.style('border', '7px solid #2a354f');
  } else {
    continueBut.position(width*0.42, height*0.76);
    continueBut.style('background-color', '#663741');
    continueBut.style('border', '7px solid #150d0f');
  }
